          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                <div class="col-sm-9">
                  <textarea rows="4" cols="50" name="inf_text" placeholder="<%= (infVO==null)? "請輸入內容" : infVO.getInf_text()%>" class="from-control"></textarea>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <div class="col-sm-9">
                  <input type="file" class="touch" name="inf_pic" size="50" value="<%= (infVO==null)? "100" : infVO.getInf_pic()%>" />
