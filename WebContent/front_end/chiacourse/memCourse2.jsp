...
<jsp:include page="/front_end/navbar.jsp" flush="true"/>
...
<%-- <jsp:include page="/front_end/navbar.jsp" flush="true"/> --%>
	...
	<div class="container">
		<div class="row">
			...
			<a
				href="<%=request.getContextPath()%>/front_end/chiacourse/listmemcoumovajax.jsp">前往觀看課程動作</a>
		</div>
	</div>
...
// 			  </form>
			  ...
			  str +="<img src='<%=request.getContextPath()%>/DBimgReader_Mov.do?mov_id="+jsonStr.infList[i].mov_id+"' alt=''>";
...
// 			  str +="<input type='hidden' name='cou_id' value='C000001'>";
			  ...
			  str +="<p>";
// 			  保留
// 			  str +="<input type='button' class='btn btn-primary' onclick='addCou(this);'>加入課程清單</a>";
			  ...
			  str+="<input type='hidden' class='btn btn-info' name='action' value='insert_chia'>";
